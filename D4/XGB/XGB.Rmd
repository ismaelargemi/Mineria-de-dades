...
```
Por otro lado, en este gráfico se puede observar la evolución del error en función del número de iteraciones. Nos muestra como este valor tiende a estabilizarse alrededor de 50. Así se fija el número de rondas en este valor.
...
Primer nivel: Se realiza una división utilizando la característica log_AMT_CREDIT con un umbral de < 0.115123019. Si se cumple esta condición, se avanza al segundo nivel; de lo contrario, se llega a una hoja. Esta característica és el logaritmo de
...
Segundo nivel: Se divide utilizando la característica OWN_CAR_AGE con un umbral de < 11.8223429. Si se cumple la condición, se avanza al tercer nivel A; de lo contrario, se accede al nivel B.

Tercer nivel A: Se divide utilizando la característica CAR_AGE con un umbral de < 16.5.

Tercer nivel B: Se divide utilizando la característica CNT_FAM_MEMBERS con un umbral de < 4.8.
