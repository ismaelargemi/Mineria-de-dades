...
```
A partir la matriz de confusión del modelo escogido entrenado con los datos de entrenamiento, en este conjunto de datos train se obtiene un Recall de 'r sensitivity_train' y una Especificidad de 'r specificity_train'.
