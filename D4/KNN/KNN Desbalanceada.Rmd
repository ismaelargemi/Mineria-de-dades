...
La "Sensitivity" mide la proporción de individuos de TARGET=0 que han sido clasificados correctamente, que en este caso ha sido de `r conf_matrix$byClass["Sensitivity"]`.
