...
load("/Users/blancaromero/Documents/GitHub/Mineria-de-dades/D1/Dades seleccionades.RData")
```
...
```
Antes de imputar los valores numéricos, será necesario pasar los NA a categoría `unknown`:
