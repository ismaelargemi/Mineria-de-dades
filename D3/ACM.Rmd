...
````
Hem provat de hacer las tres dimensions y no hi ha ningún gràfic significatiu per poder extreure més de la que ja hem extret amb les dues dimensions. Per tant ens quedem amb gràfics de dos dimensions.


## Conclusiones
```{r}
# Gráfico de individuos y variables en un solo gráfico
