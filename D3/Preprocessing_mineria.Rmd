...
bbc_style = function() 
{
  ...
  ggplot2::theme(plot.title = ggplot2::element_text(family = font, 
                                                    size = 22, face = "bold", color = "#222222"), plot.subtitle = ggplot2::element_text(family = font, 
                                                                                                                                        size = 16, margin = ggplot2::margin(2, 0, 5, 0)), plot.caption = ggplot2::element_blank(), 
                 ...
                 axis.text = ggplot2::element_text(family = font, size = 12, 
                                                   color = "#222222"), axis.text.x = ggplot2::element_text(margin = ggplot2::margin(-5, 
                                                                                                                                    b = 2)), axis.ticks = ggplot2::element_blank(), 
