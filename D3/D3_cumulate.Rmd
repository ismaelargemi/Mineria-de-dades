...
Así pues, tras hacer un análisis general, se procede a realizar un análisi más particular. Para ello, analizaremos cada variable una a una, de formaa gráfica:
