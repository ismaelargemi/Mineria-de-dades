...
Una vez se han establecido los planos factoriales gracias a las variables nunéricas, es necesario representar también las variables categóricas para así acabar de hacer un estudio completo usando toda la base de datos de nuestra variable. De esta forma, se han representado los centroides de las coordenadas de cada nivel de cada variable categórica y se han obtenido los siguientes resultados:

## Representación de las variables categoricas en los planos factoriales del PCA
...
En este primer gráfico no se puede ver nada con claredad, por eso vamos a representar cada una de las variables categoricas en un gráfico distinto:
