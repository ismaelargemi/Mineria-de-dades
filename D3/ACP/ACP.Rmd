...
eje1 <- 1
eje2 <- 2
plot(Psi[,eje1],Psi[,eje2],ylab = "PC2",xlab="PC1",main="Proyección de observaciones entre PC1 i PC2")
# autoplot(pc1)
...
Para la variable **NAME_FAMILY_STATUS** se puede apreciar que los individuos de la categoria "Widow" són también tienen menores ingresos y créditos concedidos de menor valor. En cambio para la variable **OCUPATION_TYPE** se puede observar que las categorias de "Mid-high skill laborers" y "High skill laborers" representan lo contrario, tienen mayores ingresos y créditos concedidos de mayor valor.

Para la variable **REGION_RATING_CLIENT** vemos que como mejor es la "puntuación" de la región mayores ingresos tienen y más créditos se les han concedido. 
