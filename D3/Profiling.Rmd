...
```{r}
ggplot(data = dades, aes(x = P, y = dades$OWN_CAR_AGE)) + 
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$OWN_CAR_AGE)) +
  labs(title = paste("Means of", names(dades)[8], "by", nameP), y = "Mean")
```
```{r}
#SALE NO SIGN PERO PARECE EXPLICAR LOS ClÚSTERS
ggplot(data = dades, aes(x = P, y = dades$CNT_FAM_MEMBERS)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$CNT_FAM_MEMBERS)) +
  labs(title = paste("Means of", names(dades)[9], "by", nameP), y = "Mean")
```
```{r}
ggplot(data = dades, aes(x = P, y = dades$log_AMT_INCOME_TOTAL)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$log_AMT_INCOME_TOTAL)) +
  labs(title = paste("Means of", names(dades)[10], "by", nameP), y = "Mean")

```

```{r}
ggplot(data = dades, aes(x = P, y = dades$log_AMT_CREDIT)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$log_AMT_CREDIT)) +
  labs(title = paste("Means of", names(dades)[11], "by", nameP), y = "Mean")

```
```{r}
ggplot(data = dades, aes(x = P, y = dades$AGE_YEARS)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$AGE_YEARS)) +
  labs(title = paste("Means of", names(dades)[12], "by", nameP), y = "Mean")

```
```{r}
ggplot(data = dades, aes(x = P, y = dades$RATIO_CREDIT_INCOME)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$RATIO_CREDIT_INCOME)) +
  labs(title = paste("Means of", names(dades)[13], "by", nameP), y = "Mean")
```
```{r}
ggplot(data = dades, aes(x = P, y = dades$RATIO_ANNUITY_CREDIT)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$RATIO_ANNUITY_CREDIT)) +
  labs(title = paste("Means of", names(dades)[14], "by", nameP), y = "Mean")

```
```{r}
ggplot(data = dades, aes(x = P, y = dades$DTI_RATIO)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_hline(yintercept = mean(dades$DTI_RATIO)) +
  labs(title = paste("Means of", names(dades)[15], "by", nameP), y = "Mean")
...
ggplot(data = dades, aes(x = P, fill = dades$CODE_GENDER)) +
  ...
  labs(title = paste("Prop. of pos & neg by", names(dades)[1]), y = "Proportion") +
  theme(legend.position = "top")
```

```{r}
ggplot(data = dades, aes(x = P, fill = dades$NAME_INCOME_TYPE)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[2]), y = "Proportion") +
  theme(legend.position = "top")
```
...
ggplot(data = dades, aes(x = P, fill = dades$NAME_INCOME_TYPE)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[3]), y = "Proportion") +
  theme(legend.position = "top")
```
```{r}
ggplot(data = dades, aes(x = P, fill = dades$NAME_EDUCATION_TYPE)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[4]), y = "Proportion") +
  theme(legend.position = "top")
```
```{r}
ggplot(data = dades, aes(x = P, fill = dades$NAME_FAMILY_STATUS)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[5]), y = "Proportion") +
  theme(legend.position = "top")
```
```{r}
ggplot(data = dades, aes(x = P, fill = dades$OCCUPATION_TYPE)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[6]), y = "Proportion",x = "Cluster") +
  theme(legend.position = "top")
```

```{r}
ggplot(data = dades, aes(x = P, fill = dades$ORGANIZATION_TYPE)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[7]), y = "Proportion") +
  theme(legend.position = "top")
```

```{r}
ggplot(data = dades, aes(x = P, fill = dades$REGION_RATING_CLIENT)) +
  geom_bar(position = "dodge") +
  labs(title = paste("Prop. of pos & neg by", names(dades)[8]), y = "Proportion") +
  theme(legend.position = "top")
```
...
# library(ggplot2)
# El mismo graf pero con pijadas
...
# CATEGORICA AGRUPANDO POR P CLÚster
# library(ggplot2)
# #Barplot
# ggplot(data = dades, aes(x = P, fill = dades$CODE_GENDER)) +
#   geom_bar(position = "dodge") +
