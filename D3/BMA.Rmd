...
Con target = 0 obtenemos `r subconjunto.target0` y con tagret = 1 `r subconjunto.target1`. 

Vemos las 10 primeras reglas en cada caso con mayor lift, es decir, van ordenadas de forma decreciente siendo la primera la que tiene una mayor asociación encontrada con la variable respuesta. 
